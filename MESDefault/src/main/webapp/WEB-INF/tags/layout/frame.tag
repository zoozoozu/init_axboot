<%@ tag import="com.delcam.utils.CommonCodeUtils" %>
...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/assets/js/plugins.js?v=${_VERSION}' />"></script>
    <script type="text/javascript" src="<c:url value='/assets/js/axboot/dist/axboot.js?v=${_VERSION}' />"></script>
    <script type="text/javascript" src="<c:url value='/axboot.config.js?v=${_VERSION}' />"></script>
            ...
            <div class="ax-split-panel text-align-right">
                ...
                <div class="ax-split-col ax-frame-user-info">
                     ...
                     <div class="ax-split-panel">
                		<a href="#ax" style="color:black;" onclick="window.open('/jsp/UpdateHistory.jsp','HISTORY','left= screen.width/2   ,top=screen.height/2 ,width=520,height=320');">Version ${_VERSION} </a>
                    </div>
                    ...
                    <div class="ax-split-panel">
                        <a href="#ax" onclick="window.open('/jsp/system/auth-user.jsp','MYPAGE','left=screen.width/2,top=screen.height/2,width=520,height=640')"><ax:lang id="ax.admin.login.status.message" args="${loginUser.userNm}"/></a>
                    </div>
                    <div class="panel-split"></div>
                    <div class="ax-split-panel">
                        <a href="#ax" class="ax-frame-logout" onclick="location.href = '${pageContext.request.contextPath}/api/logout';">
                            <i class="cqc-log-out"></i><ax:lang id="ax.admin.logout"/>
                        </a>
                    </div>
                </div>
