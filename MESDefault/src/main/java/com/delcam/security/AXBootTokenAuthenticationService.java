package com.delcam.security;

import com.delcam.code.GlobalConstants;
...
public class AXBootTokenAuthenticationService {
    ...
    public Authentication getAuthentication(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (!requestUri.startsWith(ContextUtil.getBaseApiPath())) {
            ...
            requestUtils.setAttribute("_VERSION",    _version); 
